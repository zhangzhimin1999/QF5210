...
date_range=case_data[1:t,1]

plot(date_range[2:t],increase_rate_sg,ylab = "Singapore Increase Rate",xlab="Date",type='l')
plot(date_range[2:t],increase_rate_uk,ylab = "United Kingdom Increase Rate",xlab="Date",type='l')
plot(date_range[2:t],increase_rate_us,ylab = "United States Increase Rate",xlab="Date",type='l')
...
pairs(total_data_sg_before_M5)
pairs(total_data_uk_before_M5)
pairs(total_data_us_before_M5)
